...
describe("jargon(string)", () => {
	...
	describe(".snake", () => {
		...
		it("should provide a way to get a snake cased string from title cased string containing numbers", () => {
			jargon("Apple 20 Tree Lake").snake.toString().should.equal("apple_20_tree_lake");
		});
	});
